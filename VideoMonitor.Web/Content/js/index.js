...
function GetLoadNav() {
    ...
    $.each(data, function (i) {
        ...
        if (row.ParentId == "0") {
            _html += '<li>';
            _html += '<a data-id="' + row.Id + '" href="#" class="dropdown-toggle"><i class="' + row.Ico + '"></i><span>' + row.PermissionName + '</span><i class="fa fa-angle-right drop-icon"></i></a>';
            ...
            if (childNodes.length > 0) {
                ...
                $.each(childNodes, function (i) {
                    ...
                    _html += '<li>';
                    _html += '<a class="menuItem" data-id="' + subrow.Id + '" href="' + subrow.LinkUrl + '" data-index="' + subrow.ParentId + '">' + subrow.PermissionName + '</a>';
                    _html += '</li>';
                });
                _html += '</ul>';
            }
